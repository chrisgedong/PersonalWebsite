            ...
            <Fade left={isDesktop} bottom={isMobile} duration={1000} delay={1000} distance="30px">
              <div className="about-wrapper__info">
                <p className="about-wrapper__info-text">
                  {paragraphOne ||
                    'I really do it all--development, gaming, fashion, photography, cars, fitness, and a variety of obscure hobbies. My motto is to work hard, fail fast, and LEARN fast in pursuit of achieving my personal/team oriented goals.'}
                </p>
                <p className="about-wrapper__info-text">
                  {paragraphTwo ||
